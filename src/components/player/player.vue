      ...
      <div class="normal-player" v-show="fullScreen" ref="normal">
          ...
          <Scroll class="middle-r" ref="lyricList" :data="currentLyric && currentLyric.lines">
            <div class="lyric-wrapper">
              <div v-if="currentLyric">
                <p ref="lyricLine"
                   class="text" :class="{'current':currentLineNum === index}" v-for="(line,index) in currentLyric.lines">{{line.txt}}</p>
              </div>
            </div>
          </Scroll>
        </div>
        <div class="bottom">
          ...
          <div class="progress-wrapper">
            <span class="time time-l">{{fotmat(currentTime)}}</span>
            <div class="progress-bar-wrapper">
              <progress-bar :percent="percent" @percentChange="percentChange"></progress-bar>
            </div>
            <span class="time time-r">{{fotmat(currentSong.duration)}}</span>
          </div>
          <div class="operators">
  ...
  export default {
    ...
    methods: {
      ...
      percentChange(percent) {
        let changeTime = percent * this.currentSong.duration
      ...
      getLyric() {
        this.currentSong.getLyric().then((lyric) => {
          ...
          this.currentLyric = new Lyric(lyric, this.handlleLyric)
          if (this.playing) {
      ...
      _getPosAndScale() {
        ...
        const y = window.clientHeight - paddingTop - targetWidth / 2 - paddingBottom
        return {
          x,
          y,
          scale
